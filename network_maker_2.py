...
class Big:
    ...
    def tree_to_array(self, file_name):
        ...
        tree_text = open('temporary_folder/' + file_name +'.tree').readlines()    ### #change, should change dynamically
    ...
    def completer(self, file_name):
        ...
        node_net = open('temporary_folder/' + file_name +'.net').readlines()
        self.node_array = []
...
def network_main():
    ...
    with open(data_json, 'r') as wfile: # this is file pulled
